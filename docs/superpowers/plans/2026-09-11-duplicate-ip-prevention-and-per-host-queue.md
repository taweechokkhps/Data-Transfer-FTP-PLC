...
- [x] **Step 1: Write failing tests in `tests/test_controllers.py`**
...
- [x] **Step 3: Implement duplicate checks in `PLCManagerController` and `PLCModalDialog`**
...
- [x] **Step 1: Write unit tests in `tests/test_controllers.py`**
...
- [x] **Step 3: Implement Per-Host Lock in `DashboardController` & UI wiring in `DashboardView`**
